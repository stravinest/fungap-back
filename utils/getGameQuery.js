...
//전체 게임 조회 로그인 ( 조회수순)
exports.gameAllViewLogin = async function (user_id) {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//전체게임 조회 비로그인(조회수순)
exports.gameAllView = async function () {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//전체 게임 조회 로그인 (인기순)
exports.gameAllPopLogin = async function (user_id) {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//전체게임 조회 비로그인(인기순)
exports.gameAllPop = async function () {
  const query = `select t1.game_id,t1.game_view_count t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
