...
export const gameAllLogin = async function (user_id: number) {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//전체 게임 조회 로그인 ( 조회수순)
export const gameAllViewLogin = async function (user_id: number) {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
  ...
  ORDER BY g.createdAt DESC) as t2
  on t1.game_id = t2.game_id
  ORDER BY t1.game_view_count DESC`;
...
//전체게임 조회 비로그인(조회수순)
export const gameAllView = async function () {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//전체 게임 조회 로그인 (인기순)
export const gameAllPopLogin = async function (user_id: number) {
  const query = `select t1.game_id,t1.game_view_count, t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//전체게임 조회 비로그인(인기순)
export const gameAllPop = async function () {
  const query = `select t1.game_id,t1.game_view_count t1.game_title,t1.like_count, t2.nickname, t2.participation_count, t2.like_state from
  (SELECT g.game_id,g.game_view_count,g.game_title,count(l.game_id) as like_count
...
//상세 게임 조회 로그인
export const gameDetailLogin = async function (
  user_id: number,
  game_id: number
) {
  ...
  from (SELECT g.game_id,g.game_view_count,g.game_desc,g.game_quest1,g.game_quest2,g.game_title,g.createdAt,count(l.game_id) as like_count
