     ...
     stage('Pull') {
      ...
      stage('Push') {
       ...
       stage('image pull') {
           ...
           sh(script: 'sudo docker tag ${DOCKER_USER_ID}/fungap:${BUILD_NUMBER} 34.64.75.136:5000/${DOCKER_USER_ID}/fungap:${BUILD_NUMBER}')
           
           sh(script: 'sudo docker push 34.64.75.136:5000/${DOCKER_USER_ID}/fungap:${BUILD_NUMBER}')
