...
services:
 ...
 ### 도커 스웜을 사용한 컨테이너 관리
  ...
  2300명 10초간 1번씩 엑세스의 경우 최고 cpu사용률이 99%를 찍었으며 최대 응답값도 2000을 넘게 되었다. 
  cpu사용률 80퍼센트 이하까지를 마지노선이라고 봤을때 2100명의 동시접속자가 10초간 1번씩의 access를 했을때까지가 최대한의 부하라고 생각 할수 있었습니다.
